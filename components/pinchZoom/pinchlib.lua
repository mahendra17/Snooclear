local mathlibapi = require("components.pinchZoom.mathlib")
...
function doPinchZoom( img, points, suppressRotation, suppressScaling, suppressTranslation )
	...
	if (olddata) then
		-- local oldfactor = 1
		-- if (oldfactor.scalefactor) then
		-- 	oldfactor = olddata.scalefactor
		-- end
		-- print(oldfactor)
		...
		-- if (newdata.scalefactor) and (olddata.scalefactor) then
		-- 	local trueFactor = olddata.scalefactor * newdata.scalefactor
		-- 	newdata.trueFactor = trueFactor
		-- 	print( trueFactor.value )
		-- end
		
		-- local newfactor = newdata.scalefactor
		-- local trueFactor = newfactor * oldfactor
		-- 
